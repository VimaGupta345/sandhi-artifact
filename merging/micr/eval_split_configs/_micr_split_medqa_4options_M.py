...
lm_eval `process_docs` hook selecting eval-split 'M' of task 'medqa_4options'.
Referenced from medqa_4options_M.yaml as `!function _micr_split_medqa_4options_M.process_docs`.
"""
